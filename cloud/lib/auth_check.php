<?php
/**
 * Guard de autenticación para cloud.
 *
 ...
 *
 * El token vive en la cookie `vigicom_token`, HttpOnly siempre, Secure en prod.
 */

require_once __DIR__ . '/jwt.php';

const JWT_COOKIE_NAME = 'vigicom_token';
...
function _wants_json(): bool
{
    ...
    // Endpoints bajo /api/ siempre responden JSON
