...
<div class="layout">
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-footer">v<?php echo e($version); ?> &middot; Vigicom Panel</div>
    </aside>
