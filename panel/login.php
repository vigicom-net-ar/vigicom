 ...
 *
 * requireAuth() redirige acá cuando no hay JWT y el request pide HTML
 * (ver lib/auth_check.php). El submit hace POST a /api/login.php por fetch;
 * si responde ok, recarga / .
 */
...
<head>
    ...
    <title>Ingresar &middot; Vigicom Panel</title>
...
<div class="login-shell">
    <div class="login-card">
        <div class="login-brand">
            ...
            <div>
                <div class="login-brand-title">Vigicom Panel</div>
                <div class="login-brand-sub">Panel de control</div>
            </div>
        </div>
        ...
        <div class="login-foot">
            &copy; <?php echo date('Y'); ?> Vigicom &middot; panel.vigicom.net.ar
        </div>
    </div>
</div>
